...
public class BankAccountDTO {
    ...
    // Aqui implementaremos la programación funcional, este bean manejará los atribustos de la cuenta del cliente
    ...
    public static long randomAccountNumber(String value) {
